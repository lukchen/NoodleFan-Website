...
const menu = [
  ...
  },
  {
    ...
    nameEn: 'Jiangxi Pork Bone & Mushroom Rice Noodle Soup',
    nameZh: '江西三鲜脊骨泡粉',
    shortZh: '三鲜脊骨泡粉',
  ...
  // ── 双人套餐 Combo for Two ──
  {
    ...
    nameEn: 'Jiangxi Brothers Combo for Two (Incl. 2 Drinks)',
    nameZh: '① 江西兄弟套餐（含饮料×2）',
...
const COMBO = {
  ham:    { id: 'combo-ham',    nameEn: 'Combo · Ham Sausage + Drink', nameZh: '套餐 · 火腿肠+饮料',              itemEn: 'Ham Sausage', itemZh: '火腿肠',        delta: 4, alaCarte: 5.5 },
  tofu:   { id: 'combo-tofu',   nameEn: 'Combo · Tofu Knots + Drink',  nameZh: '套餐 · 豆腐结+饮料',              itemEn: 'Tofu Knots',  itemZh: '豆腐结',        delta: 4, alaCarte: 5.5 },
  balls:  { id: 'combo-balls',  nameEn: 'Combo · Beef Balls + Drink',  nameZh: '套餐 · 牛肉丸+饮料',              itemEn: 'Beef Balls',  itemZh: '牛肉丸',        delta: 5.5, alaCarte: 7   },
  deluxe: { id: 'combo-deluxe', nameEn: 'Combo · Deluxe (Tofu Knots & Beef Balls) + Drink', nameZh: '套餐 · 全家福（豆腐结+牛肉丸）+饮料', itemEn: 'Tofu Knots + Beef Balls', itemZh: '豆腐结+牛肉丸', delta: 8.5, alaCarte: 10 },
}
