...
const strings = {
  en: {
    ...
    hero: {
      ...
      platforms: 'Fantuan · DoorDash · Grubhub coming soon',
      comingSoonSub: 'Search "NoodleFan" on those apps once they go live.',
  ...
  zh: {
    ...
    hero: {
      ...
      platforms: '饭团 · DoorDash · Grubhub 陆续上线',
      comingSoonSub: '上线后在这些平台搜索「粉面王」即可下单',
